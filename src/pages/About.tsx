...
export const About = () => {
  return (
    <>
      <Navbar />
      <div className="bg-gradient-to-br from-blue-100 via-white to-pink-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-base-300 p-6 sm:p-8 rounded-lg shadow-lg">
          <h1 className="text-2xl sm:text-3xl font-bold text-primary mb-4 text-center sm:text-left">
            About Us
          </h1>
          <p className="text-base-content mb-6 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="list-disc list-inside text-base-content mb-6 space-y-2 text-sm sm:text-base leading-relaxed">
